...
@InputType()
class FeedbackNoteCreateNestedManyWithoutEmployeeProfilesInput {
...
export { FeedbackNoteCreateNestedManyWithoutEmployeeProfilesInput as FeedbackNoteCreateNestedManyWithoutEmployeeProfilesInput };
