...
@InputType()
class ReviewTemplateCreateNestedManyWithoutEmployeeProfilesInput {
...
export { ReviewTemplateCreateNestedManyWithoutEmployeeProfilesInput as ReviewTemplateCreateNestedManyWithoutEmployeeProfilesInput };
