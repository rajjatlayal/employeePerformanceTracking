  ...
  test("POST /reports", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        generatedDate: CREATE_RESULT.generatedDate.toISOString(),
      ...
      .expect([
        {
          ...
          generatedDate: FIND_MANY_RESULT[0].generatedDate.toISOString(),
  ...
  test("GET /reports/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        generatedDate: FIND_ONE_RESULT.generatedDate.toISOString(),
